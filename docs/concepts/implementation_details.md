...
3. **Encoding**: Each block is Base64 encoded and wrapped in an OSC 9 JSON sequence (`transfer_block`) containing a session UUID, block index, total count, and a SHA256 file checksum.
