...
All coordination is handled via standard SSH primitives. We use custom subsystems for control messages and ANSI OSC 9 sequences for invisible in-band signaling to automate the user experience.
